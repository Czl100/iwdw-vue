  ...
  <div class="content-home">
					<div class="textbox">
						...
						<div class="text indentation">
							<p>The 18th International Workshop on Digital-forensics and Watermarking (IWDW 2019) will be held in Chengdu, China from 2-4 November, 2019.
								The IWDW 2019 is a premier forum for researchers and practitioners working on novel research,
								development and applications of digital watermarking and forensics techniques for multimedia security.</p>
							<p>We invite submissions of high-quality original research papers. Each submitted paper will be reviewed
								by at least 2 reviewers. Two prizes are to be awarded for the best paper and the best student paper, respectively.
								The proceedings of IWDW 2019 will be published on the Lecture Notes in Computer Science (LNCS) by Springer. 
								Please see <a href="resource/CFP_IWDW2019.pdf">call for paper</a> for details.</p>
						</div>
					</div>
						...
						<div class="text">		
							<table>
								<tr>
									...
									<td><p>gokeyhps@scu.edu.cn</p></td>									
								</tr>
								<tr>
									<td><h3>Website:</h3></td>
									<td><p>iwdw2019.net</p></td>									
								</tr>
							</table>							
						</div>
					</div>									
